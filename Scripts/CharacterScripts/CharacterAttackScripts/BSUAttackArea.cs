...
public class BSUAttackArea : MonoBehaviour
{
    public CharacterBSU characterBSU;                                // キャラクターの取得
    ...
    {
        // ダメージを食らっていないとき
        if (characterBSU.hit == false)
        {
            // 死亡していたら
            if (characterBSU.die == true)
            {
                return;
            }
