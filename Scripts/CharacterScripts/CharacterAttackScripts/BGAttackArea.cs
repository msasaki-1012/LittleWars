...
public class BGAttackArea : MonoBehaviour
{
    public CharacterBG characterBG;     // キャラクターの取得
    ...
    {
        // ダメージを食らっていないとき
        if (characterBG.hit == false)
        {
            // 死亡していたら
            if (characterBG.die == true)
            {
                return;
            }
