...
public class BSAttackArea : MonoBehaviour
{
    public CharacterBS characterBS;                                  // キャラクターの取得
    ...
    {
        // ダメージを食らっていないとき
        if (characterBS.hit == false)
        {
            // 死亡していたら
            if (characterBS.die == true)
            {
                return;
            }
