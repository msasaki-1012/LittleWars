...
public class BWUAttackArea : MonoBehaviour
{
    public CharacterBWU characterBWU;                                  // キャラクターの取得
    ...
    {
        // ダメージを食らっていないとき
        if (characterBWU.hit == false)
        {
            // 死亡していたら
            if (characterBWU.die == true)
            {
                return;
            }
