...
public class CharacterBWU : Character
{
    ...
    void Update()
    {
        ...
        {
            // ステージ4をクリアしたら
            if (ShowIconClear.stage7WinFlg == true)
            {
                // キャラクターを見えるようにする
    ...
    private void Die()
    {
        ...
        {
            // 存在フラグをfalseに
            titleCharacterSpawn.bwuFlg = false;
    ...
    private void ShowAddCoinText()
    {
        ...
        if (SceneManager.GetActiveScene().name != "Title")
        {
            ...
            // TextMeshPro に反映
            addCoinTextInstance.GetComponentInChildren<TextMeshProUGUI>().text = "+￥" + addCoin.ToString("N0");
