...
public class CharacterBG : Character
{
    private Animator anim;                              // アニメーション
    private Spawn spawnPos;                             // キャラクター生成
    private TitleCharacterSpawn titleCharacterSpawn;    // タイトルのキャラクター生成
    private TutorialCharacterSpawn tutorialCharacterSpawn;  // チュートリアルのキャラクター生成
    ...
    [SerializeField]
    private SpriteRenderer characterSpriteRenderer;      // スプライトを表示するコンポーネント
    ...
    private float minFlipInterval = 1.0f;               // 最小向き変更間隔（秒）
    private float maxFlipInterval = 3.0f;               // 最大向き変更間隔（秒）
    ...
    void Start()
    {
        ...
        {
            tutorialCharacterSpawn = GameObject.Find("GameManager").GetComponent<TutorialCharacterSpawn>();
    ...
    private void Die()
    {
        ...
        {
            // キャラクターの出現数を減らす
            tutorialCharacterSpawn.characterCount--;

            // キャラクターの死亡カウントを増やす
            tutorialCharacterSpawn.deathCharacterCount++;
        }
        else
        {
            // キャラクターの出現数を減らす
