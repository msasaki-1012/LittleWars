...
public class EnemyRSU : EnemyController
{
    ...
    void Start()
    {
        ...
        // 今いるシーンがステージのとき
        if (SceneManager.GetActiveScene().name == "Stage2"|| SceneManager.GetActiveScene().name == "Stage4"|| SceneManager.GetActiveScene().name == "Stage5")
        {
            addCoin *= 1.5f;
        }
